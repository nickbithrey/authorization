...
(id, username, password, enabled, failed_attempts, max_failed_attempts) VALUES 
(HIBERNATE_SEQUENCE.nextVal, 'admin', '$2a$10$AZmT259FCn3sWHCe/Cv83urHsmJIKxeIHk4DC0N0ptEVOHSkpJd.W', 1, 0, 3);
...
(HIBERNATE_SEQUENCE.nextVal, 'admin', '$2a$10$qCmzpru7/dZ/QNRvh9VCJumwVf38pROjiHsOqfEYVIR718/nBdof.', 600, 2400);
